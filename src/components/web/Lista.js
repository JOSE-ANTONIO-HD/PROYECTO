...
function Tabla() {
    ...
    const [fechaActualizacion, setFechaActualizacion] = useState(""); // Estado para almacenar la fecha de actualización
    ...
    useEffect(() => {
        ...
        setFechaActualizacion(fechaActual); // Establece la fecha actual una vez cuando se monta el componente
    }, []);
                    ...
                    <tbody>
                        {listaDatos.map((datos, index) => (
                            <tr key={datos._id}>
                                ...
                                <td>{fechaActualizacion}</td> {/* Muestra la fecha actual */}
                                <td>
                                    <button type="button" className="btn btn-info" onClick={() => Modificar(datos._id)}>Modificar</button>
                                </td>
                                <td>
